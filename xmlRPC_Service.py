...
sys.path.append('/home/ubuntu/ExoDAO-re-Isearch/swig')
sys.path.append('/home/ubuntu/ExoDAO-re-Isearch/lib')
from IB import *

# Set up logging
logging.basicConfig(level=logging.DEBUG)
 
server = SimpleXMLRPCServer((sys.argv[1], 18861), logRequests=True)
...
# this method returns the results of this service
		...
		query.SetSortBy(getranking(arg2))
